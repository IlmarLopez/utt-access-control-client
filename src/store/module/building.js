/** VUEX module for user management */
import Vue from 'vue';
...
export default {
  ...
  actions: {
    ...
    FETCH_SINGLE({ commit }, id) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: `buildings/${id}`, method: 'GET' })
          .then((response) => {
            resolve(response);
    ...
    FETCH_CREATE({ commit }, payload) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: 'buildings', data: payload.data, method: 'POST' })
          .then((response) => {
            resolve(response);
    ...
    FETCH_DELETE({ commit }, id) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: `buildings/${id}`, method: 'DELETE' })
          .then((response) => {
            resolve(response);
