/** VUEX module for building management */
import Vue from 'vue';
  ...
  actions: {
    ...
    FETCH_LIST({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({
            url: `users?term=${payload.term}&filters=${filtersJSON}&page=${payload.page}&per_page=${payload.per_page}`,
            method: 'GET',
          })
          .then((response) => {
            resolve(response);
    ...
    FETCH_CREATE({ commit }, payload) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: 'users', data: payload.data, method: 'POST' })
          .then((response) => {
            resolve(response);
    ...
    FETCH_DELETE({ commit }, id) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: `users/${id}`, method: 'DELETE' })
          .then((response) => {
            resolve(response);
