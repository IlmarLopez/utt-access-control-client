/** VUEX module for building accesses management */
import Vue from 'vue';
  ...
  actions: {
    ...
    FETCH_LIST({ commit }, payload) {
      ...
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({
            url: `building-accesses?term=${payload.term}&filters=${filtersJSON}&page=${payload.page}&per_page=${payload.per_page}`,
            method: 'GET',
          })
          .then((response) => {
            resolve(response);
    ...
    FETCH_SINGLE({ commit }, id) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: `building-accesses/${id}`, method: 'GET' })
          .then((response) => {
            resolve(response);
    ...
    FETCH_CREATE({ commit }, payload) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: 'building-accesses', data: payload.data, method: 'POST' })
          .then((response) => {
            resolve(response);
    ...
    FETCH_UPDATE({ commit }, payload) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({
            url: `building-accesses/${payload.id}`,
            data: payload.data,
            method: 'PUT',
          })
          .then((response) => {
    ...
    FETCH_DELETE({ commit }, id) {
      return new Promise((resolve, reject) => {
        Vue.prototype
          .$http({ url: `building-accesses/${id}`, method: 'DELETE' })
          .then((response) => {
            resolve(response);
